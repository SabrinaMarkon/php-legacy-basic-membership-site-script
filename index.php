...
<br>
<a href="http://demomembershipbasic.phpsitescripts.com/admin" target="_blank"><img src="http://phpsitescripts.com/images/demo.png" border="0"></a>
<br><br><br>
Please check out our interactive DEMO of the Basic Membership Site Script as an admin <a href="http://demomembershipbasic.phpsitescripts.com/admin" target="_blank">HERE</a> (admin login details are already in the login form for you). <br><br>Examine our DEMO site as a member <a href="http://demomembershipbasic.phpsitescripts.com/login.php" target="_blank">HERE</a> (demo member details are already in the login form)</b><br><br>
...
<tr><td colspan="2" align="center"><br><font size="6" color="ff0000">Buy This Basic Membership Site Script Now For Only $49.00!</font></td</tr>
<form action="http://phpsitescripts.com/sales_order.php" method="post">
<tr><td align="right">Licence:</td><td>Single Site License for Basic Membership Site Script</td></tr>
...
<input type="hidden" name="order_script" value="basic_membership_site_v11.1">
